    ...
    <>
      ...
      <div className="flex flex-col gap-3 px-4 my-3">
        ...
        <div className="flex items-center gap-3 ">
          <button
            className="bg-vibrantBlue w-full py-3 text-white font-semibold rounded-lg px-2 mx-4 font-poppins"
            onClick={rentMoive}
          >
            Rent ₹ 149
          </button>
          <button
            className="bg-premier-700 w-full py-3 pl-2 text-white font-semibold rounded-lg font-poppins"
            onClick={buyMoive}
          >
            Buy ₹ 599
          </button>
